<?php
    if(isset($_POST['n_titulo'])){
        ...
        `musica`(`titulo`, `data_lanc`, `artista`, `genero`, `url_arq`,`usuario_id`) 
        VALUES ('$titulo',(CURDATE()),'".$_SESSION['nome']."','$genero','$path_msc','".$_SESSION['id']."')");

        ?>
        <script>
            alert("Cadastrado com sucesso!");
            window.location.replace("../musica/musica.php");
        </script>
        <?php
